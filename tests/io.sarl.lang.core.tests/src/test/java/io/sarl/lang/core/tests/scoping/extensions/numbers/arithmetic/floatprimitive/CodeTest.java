...
import static io.sarl.lang.core.scoping.extensions.numbers.arithmetic.PrimitiveFloatArithmeticExtensions.operator_divide;
import static io.sarl.lang.core.scoping.extensions.numbers.arithmetic.PrimitiveFloatArithmeticExtensions.operator_minus;
import static io.sarl.lang.core.scoping.extensions.numbers.arithmetic.PrimitiveFloatArithmeticExtensions.operator_modulo;
import static io.sarl.lang.core.scoping.extensions.numbers.arithmetic.PrimitiveFloatArithmeticExtensions.operator_multiply;
import static io.sarl.lang.core.scoping.extensions.numbers.arithmetic.PrimitiveFloatArithmeticExtensions.operator_plus;
import static io.sarl.lang.core.scoping.extensions.numbers.arithmetic.PrimitiveFloatArithmeticExtensions.operator_power;
...
public class CodeTest extends AbstractSarlTest {
	...
	public void operator_minus_float_Long() throws Exception {
		assertEpsilonEquals(1f, operator_minus(left, Long.valueOf(right)));
	}

	@Test
	public void operator_minus_float_Byte() throws Exception {
		assertEpsilonEquals(1f, operator_minus(left, Byte.valueOf((byte)right)));
	}
	...
	public void operator_minus_float_Integer() throws Exception {
		assertEpsilonEquals(1f, operator_minus(left, Integer.valueOf(right)));
	}

	@Test
	public void operator_minus_float_Short() throws Exception {
		assertEpsilonEquals(1f, operator_minus(left, Short.valueOf((short) right)));
	}
	...
	public void operator_divide_float_Long() throws Exception {
		assertEpsilonEquals(1.333333333333333333, operator_divide(left, Long.valueOf(right)));
	}

	@Test
	public void operator_divide_float_Byte() throws Exception {
		assertEpsilonEquals(1.333333333333333333, operator_divide(left, Byte.valueOf((byte) right)));
	}
	...
	public void operator_divide_float_Integer() throws Exception {
		assertEpsilonEquals(1.333333333333333333, operator_divide(left, Integer.valueOf(right)));
	}
	...
	public void operator_divide_float_Short() throws Exception {
		assertEpsilonEquals(1.333333333333333333, operator_divide(left, Short.valueOf((short) right)));
	}

	@Test
	public void operator_divide_float_AtomicInteger() throws Exception {
		assertEpsilonEquals(1.333333333333333333, operator_divide(left, new AtomicInteger(right)));
	}

	@Test
	public void operator_divide_float_AtomicLong() throws Exception {
		assertEpsilonEquals(1.333333333333333333, operator_divide(left, new AtomicLong(right)));
	}
