...
public class CompilerTest extends AbstractSarlTest {
	...
	public static void operator_greaterThan_Byte_byte(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final byte right) {",
	...
	public static void operator_greaterThan_Byte_short(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final short right) {",
						"    return (left.longValue() > right);",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_greaterThan_Byte_int(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final int right) {",
						"    return (left.longValue() > right);",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_greaterThan_Byte_long(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final long right) {",
						"    return (left.longValue() > right);",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_greaterThan_Byte_float(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final float right) {",
						"    return (left.longValue() > right);",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_greaterThan_Byte_double(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final double right) {",
						"    return (left.longValue() > right);",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_greaterThan_Byte_Integer(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final Integer right) {",
						"    return (left.longValue() > right.doubleValue());",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_greaterThan_Byte_AtomicInteger(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				"class A {",
				"  def fct(left : Long, right : AtomicInteger) : boolean {",
				"    left > right",
				"  }",
				"}"),
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final AtomicInteger right) {",
						"    return (left.longValue() > right.doubleValue());",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_greaterThan_Byte_AtomicLong(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				"class A {",
				"  def fct(left : Long, right : AtomicLong) : boolean {",
				"    left > right",
				"  }",
				"}"),
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final AtomicLong right) {",
						"    return (left.longValue() > right.doubleValue());",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_greaterThan_Byte_Number(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				"class A {",
				"  def fct(left : Long, right : AtomicDouble) : boolean {",
				"    left > right",
				"  }",
				"}"),
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public boolean fct(final Long left, final AtomicDouble right) {",
						"    return (left.longValue() > right.doubleValue());",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_spaceship_Byte_byte(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final byte right) {",
	...
	public static void operator_spaceship_Byte_short(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final short right) {",
						"    return Long.compare(left.longValue(), right);",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_spaceship_Byte_int(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final int right) {",
						"    return Long.compare(left.longValue(), right);",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_spaceship_Byte_long(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final long right) {",
						"    return Long.compare(left.longValue(), right);",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_spaceship_Byte_float(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final float right) {",
	...
	public static void operator_spaceship_Byte_double(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final double right) {",
	...
	public static void operator_spaceship_Byte_Integer(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				...
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final Integer right) {",
	...
	public static void operator_spaceship_Byte_AtomicInteger(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				"import java.util.concurrent.atomic.AtomicInteger",
				"class A {",
				"  def fct(left : Long, right : AtomicInteger) : int {",
				"    left <=> right",
				"  }",
				"}"),
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final AtomicInteger right) {",
						"    return Long.compare(left.longValue(), right.intValue());",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_spaceship_Byte_AtomicLong(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				"import java.util.concurrent.atomic.AtomicLong",
				"class A {",
				"  def fct(left : Long, right : AtomicLong) : int {",
				"    left <=> right",
				"  }",
				"}"),
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final AtomicLong right) {",
						"    return Long.compare(left.longValue(), right.longValue());",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public static void operator_spaceship_Byte_Number(Context ctx) throws Exception {
		ctx.compileTo(multilineString(
				"import com.google.common.util.concurrent.AtomicDouble",
				"class A {",
				"  def fct(left : Long, right : AtomicDouble) : int {",
				"    left <=> right",
				"  }",
				"}"),
				multilineString(
						...
						"public class A {",
						"  @Pure",
						"  public int fct(final Long left, final AtomicDouble right) {",
						"    return Double.compare(left.longValue(), right.doubleValue());",
						"  }",
						"  ",
						"  @SyntheticMember",
