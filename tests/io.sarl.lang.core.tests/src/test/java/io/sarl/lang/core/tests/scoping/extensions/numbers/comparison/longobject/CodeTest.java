...
public class CodeTest extends AbstractSarlTest {
	...
	private static Long left = 4l;

	private static Long left2 = 2l;
	...
	public void operator_spaceship_Byte_short() {
		...
		assertZero(operator_spaceship(left, (short) left.longValue()));
	}
	...
	public void operator_spaceship_Byte_int() {
		...
		assertZero(operator_spaceship(left, (int) left.longValue()));
	}
	...
	public void operator_spaceship_Byte_Short() {
		...
		assertZero(operator_spaceship(left, Short.valueOf((short) left.longValue())));
	}
