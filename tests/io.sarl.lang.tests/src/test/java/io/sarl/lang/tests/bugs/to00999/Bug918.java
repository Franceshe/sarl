...
public class Bug918 extends AbstractSarlTest {
	...
	private static final String X_JAVA_CODE = multilineString(
			...
			"import io.sarl.lang.tests.bug918.A;",
	...
	private static final String Y_JAVA_CODE = multilineString(
			...
			"import io.sarl.lang.core.DynamicSkillProvider;",
			"import io.sarl.lang.tests.bug918.A;",
			"import io.sarl.lang.tests.bug918.B;",
			"import io.sarl.lang.tests.bug918.C;",
			"import io.sarl.lang.tests.bug918.D;",
			"import io.sarl.lang.tests.bug918.X;",
			"import java.util.UUID;",
			"import javax.inject.Inject;",
			"import org.eclipse.xtext.xbase.lib.Pure;",
			"",
			...
			"  @Deprecated",
			"  @Inject",
			"  public Y(final BuiltinCapacitiesProvider arg0, final UUID arg1, final UUID arg2) {",
			"    super(arg0, arg1, arg2);",
			"  }",
			"  ",
			"  @SyntheticMember",
