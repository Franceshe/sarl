...
public class Bug885 extends AbstractSarlTest {
	...
	private static final String EXPECTED_LOCAL_PARAMETER = multilineString(
			...
			"      public boolean matches(final Address it) {",
			"        UUID _uUID = it.getUUID();",
			"        UUID _uUID_1 = p.getUUID();",
			"        return Objects.equal(_uUID, _uUID_1);",
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
			"        return new SerializableProxy($SerializableClosureProxy.class, p.getUUID());",
			"      }",
			"    };",
			"    this.f(_function);",
			"  }",
	...
	private static final String EXPECTED_FIELD = multilineString(
			...
			"      public boolean matches(final Address it) {",
			"        UUID _uUID = it.getUUID();",
			"        UUID _uUID_1 = Boot.this.p.getUUID();",
			"        return Objects.equal(_uUID, _uUID_1);",
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
	...
	public void compilingField() throws Exception {
		SarlScript mas = file(SNIPSET_FIELD);
		final Validator validator = validate(mas);
		validator.assertNoErrors();
	...
	private static final String EXPECTED_SUPER_FIELD = multilineString(
			...
			"import io.sarl.lang.core.DynamicSkillProvider;",
			"import io.sarl.lang.core.Scope;",
			"import io.sarl.lang.tests.bug885.SuperBoot;",
			"import io.sarl.lang.util.SerializableProxy;",
			"import java.io.ObjectStreamException;",
			"import java.util.UUID;",
			"import javax.inject.Inject;",
	...
	private static final String EXPECTED_LOCAL_FUNCTION_01 = multilineString(
			...
			"      public boolean matches(final Address it) {",
			"        UUID _uUID = it.getUUID();",
			"        UUID _uUID_1 = Boot.this.callF().getUUID();",
			"        return Objects.equal(_uUID, _uUID_1);",
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
	...
	private static final String EXPECTED_EXTENSION_FIELD = multilineString(
			...
			"import io.sarl.lang.core.DynamicSkillProvider;",
			"import io.sarl.lang.core.Scope;",
			"import io.sarl.lang.tests.bug885.Provider;",
			"import io.sarl.lang.util.SerializableProxy;",
			"import java.io.ObjectStreamException;",
			"import java.util.UUID;",
			"import javax.inject.Inject;",
			...
			"      public boolean matches(final Address it) {",
			"        UUID _uUID = it.getUUID();",
			"        UUID _uUID_1 = Boot.this.p.callF().getUUID();",
			"        return Objects.equal(_uUID, _uUID_1);",
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
	...
	private static final String EXPECTED_EXTENSION_VARIABLE = multilineString(
			...
			"      public boolean matches(final Address it) {",
			"        UUID _uUID = it.getUUID();",
			"        UUID _uUID_1 = p.callF().getUUID();",
			"        return Objects.equal(_uUID, _uUID_1);",
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
			"        return new SerializableProxy($SerializableClosureProxy.class, p.callF().getUUID());",
			"      }",
			"    };",
			"    this.f(_function);",
			"  }",
	...
	private static final String EXPECTED_STATIC_IMPORT = multilineString(
			...
			"      public boolean matches(final Address it) {",
			"        UUID _uUID = it.getUUID();",
			"        UUID _uUID_1 = StaticTools.getAdr().getUUID();",
			"        return Objects.equal(_uUID, _uUID_1);",
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
			"        return new SerializableProxy($SerializableClosureProxy.class, StaticTools.getAdr().getUUID());",
			"      }",
			"    };",
			"    this.f(_function);",
			"  }",
	...
	private static final String EXPECTED_STATIC_EXTENSION_IMPORT = multilineString(
			...
			"      public boolean matches(final Address it) {",
			"        UUID _uUID = it.getUUID();",
			"        UUID _uUID_1 = StaticTools.getAdr2(new Object()).getUUID();",
			"        return Objects.equal(_uUID, _uUID_1);",
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
			"        return new SerializableProxy($SerializableClosureProxy.class, StaticTools.getAdr2(new Object()).getUUID());",
			"      }",
			"    };",
			"    this.f(_function);",
			"  }",
	...
	private static final String EXPECTED_IS_ME = multilineString(
			...
			"import io.sarl.lang.tests.bug885.MyEvent;",
			...
			"    boolean _isMe = (it.getSource() != null && this.getID().equals(it.getSource().getUUID()));",
			"    return (!_isMe);",
			"  }",
			"  ",
			"  @Extension",
	...
	private static final String EXPECTED_LOCAL_STATIC_FUNCTION_01 = multilineString(
			...
			"      public boolean matches(final Address it) {",
			"        UUID _uUID = it.getUUID();",
			"        UUID _uUID_1 = Boot.callF().getUUID();",
			"        return Objects.equal(_uUID, _uUID_1);",
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
			"        return new SerializableProxy($SerializableClosureProxy.class, Boot.callF().getUUID());",
			"      }",
			"    };",
			"    this.f(_function);",
			"  }",
	...
	private static final String EXPECTED_COMPLEX_LAMBDA_02 = multilineString(
			...
			"      }",
			"      private Object writeReplace() throws ObjectStreamException {",
			"        return new SerializableProxy($SerializableClosureProxy.class, a, a.getUUID());",
			"      }",
			"    };",
			"    this.f(_function);",
			"  }",
	...
	private static final String EXPECTED_COMPLEX_LAMBDA_03 = multilineString(
			...
			"        @Override",
			"        public boolean matches(final Address it) {",
			"          java.util.UUID _uUID = it.getUUID();",
