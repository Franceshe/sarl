...
public class AgentCompilerTest extends AbstractSarlTest {
	...
	public void actionmodifier_override() throws Exception {
		...
		final String expectedA2 = multilineString(
				...
				"  @Deprecated",
				"  @Inject",
				"  public A2(final BuiltinCapacitiesProvider arg0, final UUID arg1, final UUID arg2) {",
				"    super(arg0, arg1, arg2);",
				"  }",
				"  ", 
				"  @SyntheticMember", 
	...
	public void inlinedCapacityFunctionCall_nativeParameter() throws Exception {
		...
		final String expectedA1 = multilineString(
				...
				"    C1 _$CAPACITY_USE$C1$CALLER = this.$castSkill(C1.class, (this.$CAPACITY_USE$C1 == null || this.$CAPACITY_USE$C1.get() == null) ? (this.$CAPACITY_USE$C1 = this.$getSkill(C1.class)) : this.$CAPACITY_USE$C1);",
	...
	public void inlinedCapacityFunctionCall_variadicParameter01() throws Exception {
		...
		final String expectedA1 = multilineString(
			    ...
			    "    C1 _$CAPACITY_USE$C1$CALLER = this.$castSkill(C1.class, (this.$CAPACITY_USE$C1 == null || this.$CAPACITY_USE$C1.get() == null) ? (this.$CAPACITY_USE$C1 = this.$getSkill(C1.class)) : this.$CAPACITY_USE$C1);",
				"    _$CAPACITY_USE$C1$CALLER.myfunction(Integer.class);",
				"    C1 _$CAPACITY_USE$C1$CALLER_1 = this.$castSkill(C1.class, (this.$CAPACITY_USE$C1 == null || this.$CAPACITY_USE$C1.get() == null) ? (this.$CAPACITY_USE$C1 = this.$getSkill(C1.class)) : this.$CAPACITY_USE$C1);",
				"    _$CAPACITY_USE$C1$CALLER_1.myfunction(Float.class, 1);",
				"    C1 _$CAPACITY_USE$C1$CALLER_2 = this.$castSkill(C1.class, (this.$CAPACITY_USE$C1 == null || this.$CAPACITY_USE$C1.get() == null) ? (this.$CAPACITY_USE$C1 = this.$getSkill(C1.class)) : this.$CAPACITY_USE$C1);",
				"    _$CAPACITY_USE$C1$CALLER_2.myfunction(String.class, 2, 3);",
				"    C1 _$CAPACITY_USE$C1$CALLER_3 = this.$castSkill(C1.class, (this.$CAPACITY_USE$C1 == null || this.$CAPACITY_USE$C1.get() == null) ? (this.$CAPACITY_USE$C1 = this.$getSkill(C1.class)) : this.$CAPACITY_USE$C1);",
	...
	public void usePureCapacityFunction() throws Exception {
		...
		final String expectedMyAgent = multilineString(
				...
				"    C1 _$CAPACITY_USE$FOO_TEST_C1$CALLER = this.$castSkill(C1.class, (this.$CAPACITY_USE$FOO_TEST_C1 == null || this.$CAPACITY_USE$FOO_TEST_C1.get() == null) ? (this.$CAPACITY_USE$FOO_TEST_C1 = this.$getSkill(C1.class)) : this.$CAPACITY_USE$FOO_TEST_C1);",
				...
				"  @SyntheticMember",
				"  @Pure",
				"  @Inline(value = \"$castSkill(C1.class, ($0$CAPACITY_USE$FOO_TEST_C1 == null || $0$CAPACITY_USE$FOO_TEST_C1.get() == null) ? ($0$CAPACITY_USE$FOO_TEST_C1 = $0$getSkill(C1.class)) : $0$CAPACITY_USE$FOO_TEST_C1)\", imported = C1.class)",
