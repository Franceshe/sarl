		...
		public void withFunction() throws Exception {
			getCompileHelper().assertCompilesTo(SNIPSET2,
					multilineString(
							...
							"  @SyntheticMember",
							"  @SarlSourceCode(\"\\\"a\\\"\")",
							"  public static final String $DEFAULT_VALUE$MYFCT_0 = \"a\";",
							"  ",
			...
			getCompileHelper().compile(SNIPSET4,
					(it) -> {
						assertEquals(multilineString(
							...
							"  @SyntheticMember",
							"  @SarlSourceCode(\"0\")",
							"  public static final float $DEFAULT_VALUE$MYFCT2_0 = 0;",
							"  ",
			...
			getCompileHelper().compile(SNIPSET6,
					(it) -> {
						assertEquals(multilineString(
								...
								"  @SyntheticMember",
								"  @SarlSourceCode(\"0\")",
								"  public static final float $DEFAULT_VALUE$MYFCT3_0 = 0;",
								"  ",
								"  @DefaultValueUse(\"int,float\")",
								"  @SyntheticMember",
