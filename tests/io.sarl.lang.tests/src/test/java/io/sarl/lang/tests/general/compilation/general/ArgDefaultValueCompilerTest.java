	...
	public static class AgentTest extends AbstractSarlTest {
		...
		public void action_1p_int() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"4\")",
					"  private static final int $DEFAULT_VALUE$MYACTION_0 = 4;",
					"  ",
					"  @DefaultValueUse(\"int\")",
					"  @SyntheticMember",
		...
		public void action_1p_float() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"4.5f\")",
					"  private static final float $DEFAULT_VALUE$MYACTION_0 = 4.5f;",
					"  ",
		...
		public void action_1p_boolean() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"true\")",
					"  private static final boolean $DEFAULT_VALUE$MYACTION_0 = true;",
					"  ",
		...
		public void action_1p_double() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"4.5\")",
					"  private static final double $DEFAULT_VALUE$MYACTION_0 = 4.5;",
					"  ",
		...
		public void action_1p_long() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"450\")",
					"  private static final long $DEFAULT_VALUE$MYACTION_0 = 450;",
					"  ",
		...
		public void action_1p_String() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"\\\"abcd\\\"\")",
					"  private static final String $DEFAULT_VALUE$MYACTION_0 = \"abcd\";",
					"  ",
		...
		public void action_1p_char() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"\\'d\\'\")",
					"  private static final char $DEFAULT_VALUE$MYACTION_0 = 'd';",
					"  ",
		...
		public void action_5p_1() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"\\\"abc\\\"\")",
					"  private static final String $DEFAULT_VALUE$MYACTION_0 = \"abc\";",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void action_5p_2() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"18\")",
					"  private static final int $DEFAULT_VALUE$MYACTION_0 = 18;",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void action_5p_3() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"34\")",
					"  private static final int $DEFAULT_VALUE$MYACTION_0 = 34;",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void action_5p_4() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"\\\"xyz\\\"\")",
					"  private static final String $DEFAULT_VALUE$MYACTION_0 = \"xyz\";",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void action_5p_0_3() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"56\")",
					"  private static final int $DEFAULT_VALUE$MYACTION_1 = 56;",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void action_3p_vararg_1() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"45\")",
					"  private static final int $DEFAULT_VALUE$MYACTION_0 = 45;",
					"  ",
		...
		public void action_4p_0_1_2_3() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"78\")",
					"  private static final int $DEFAULT_VALUE$MYACTION_2 = 78;",
					"  ",
					"  /**",
					"   * Default value for the parameter arg3",
					"   */",
					"  @SyntheticMember",
					"  @SarlSourceCode(\"14\")",
					"  private static final int $DEFAULT_VALUE$MYACTION_3 = 14;",
					"  ",
	...
	public static class BehaviorTest extends AbstractSarlTest {
		...
		public void constructor_1p_int() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"4\")",
					"  private static final int $DEFAULT_VALUE$NEW_0 = 4;",
					"  ",
					"  @DefaultValueUse(\"int\")",
					"  @SyntheticMember",
					"  public B1() {",
		...
		public void constructor_1p_float() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"4.5f\")",
					"  private static final float $DEFAULT_VALUE$NEW_0 = 4.5f;",
					"  ",
					"  @DefaultValueUse(\"float\")",
					"  @SyntheticMember",
					"  public B1() {",
		...
		public void constructor_1p_boolean() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"true\")",
					"  private static final boolean $DEFAULT_VALUE$NEW_0 = true;",
					"  ",
					"  @DefaultValueUse(\"boolean\")",
					"  @SyntheticMember",
					"  public B1() {",
		...
		public void constructor_1p_double() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"4.5\")",
					"  private static final double $DEFAULT_VALUE$NEW_0 = 4.5;",
					"  ",
					"  @DefaultValueUse(\"double\")",
					"  @SyntheticMember",
					"  public B1() {",
		...
		public void constructor_1p_long() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"450\")",
					"  private static final long $DEFAULT_VALUE$NEW_0 = 450;",
					"  ",
					"  @DefaultValueUse(\"long\")",
					"  @SyntheticMember",
					"  public B1() {",
		...
		public void constructor_1p_String() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"\\\"abcd\\\"\")",
					"  private static final String $DEFAULT_VALUE$NEW_0 = \"abcd\";",
					"  ",
					"  @DefaultValueUse(\"java.lang.String\")",
					"  @SyntheticMember",
					"  public B1() {",
		...
		public void constructor_1p_char() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"\\'d\\'\")",
					"  private static final char $DEFAULT_VALUE$NEW_0 = 'd';",
					"  ",
					"  @DefaultValueUse(\"char\")",
					"  @SyntheticMember",
					"  public B1() {",
		...
		public void constructor_5p_1() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"\\\"abc\\\"\")",
					"  private static final String $DEFAULT_VALUE$NEW_0 = \"abc\";",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void constructor_5p_2() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"18\")",
					"  private static final int $DEFAULT_VALUE$NEW_0 = 18;",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void constructor_5p_3() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"34\")",
					"  private static final int $DEFAULT_VALUE$NEW_0 = 34;",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void constructor_5p_4() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"\\\"xyz\\\"\")",
					"  private static final String $DEFAULT_VALUE$NEW_0 = \"xyz\";",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void constructor_5p_0_3() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"56\")",
					"  private static final int $DEFAULT_VALUE$NEW_1 = 56;",
					"  ",
					"  @DefaultValueUse(\"int,java.lang.String,int,int,java.lang.String\")",
					"  @SyntheticMember",
		...
		public void constructor_3p_vararg_1() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"45\")",
					"  private static final int $DEFAULT_VALUE$NEW_0 = 45;",
					"  ",
					"  @DefaultValueUse(\"int,int,int*\")",
					"  @SyntheticMember",
		...
		public void constructor_4p_0_1_2_3() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"78\")",
					"  private static final int $DEFAULT_VALUE$NEW_2 = 78;",
					"  ",
					"  /**",
					"   * Default value for the parameter arg3",
					"   */",
					"  @SyntheticMember",
					"  @SarlSourceCode(\"14\")",
					"  private static final int $DEFAULT_VALUE$NEW_3 = 14;",
					"  ",
					"  @DefaultValueUse(\"int,int,int,int\")",
					"  @SyntheticMember",
					"  public B1() {",
	...
	public static class CapacityTest extends AbstractSarlTest {
		...
		public void capacity() throws Exception {
			...
			String expected = multilineString(
					...
					"  @DefaultValueSource",
					"  public abstract void myaction(@DefaultValue(\"C1#MYACTION_0\") final int arg0, @DefaultValue(\"C1#MYACTION_1\") final int arg1, final int arg2, @DefaultValue(\"C1#MYACTION_2\") final int arg3);",
					"  ",
					"  /**",
					"   * Default value for the parameter arg0",
					"   */",
					"  @SyntheticMember",
					"  @SarlSourceCode(\"45\")",
					"  public static final int $DEFAULT_VALUE$MYACTION_0 = 45;",
					"  ",
					"  /**",
					"   * Default value for the parameter arg1",
					"   */",
					"  @SyntheticMember",
					"  @SarlSourceCode(\"56\")",
					"  public static final int $DEFAULT_VALUE$MYACTION_1 = 56;",
					"  ",
					"  /**",
					"   * Default value for the parameter arg3",
					"   */",
					"  @SyntheticMember",
					"  @SarlSourceCode(\"14\")",
					"  public static final int $DEFAULT_VALUE$MYACTION_2 = 14;",
					"  ",
					"  @DefaultValueUse(\"int,int,int,int\")",
					"  @SyntheticMember",
					"  public default void myaction(final int arg2) {",
					"    myaction($DEFAULT_VALUE$MYACTION_0, $DEFAULT_VALUE$MYACTION_1, arg2, $DEFAULT_VALUE$MYACTION_2);",
					"  }",
					"  ",
					"  @DefaultValueUse(\"int,int,int,int\")",
					"  @SyntheticMember",
					"  public default void myaction(final int arg0, final int arg2) {",
					"    myaction(arg0, $DEFAULT_VALUE$MYACTION_1, arg2, $DEFAULT_VALUE$MYACTION_2);",
					"  }",
					"  ",
					"  @DefaultValueUse(\"int,int,int,int\")",
					"  @SyntheticMember",
					"  public default void myaction(final int arg0, final int arg1, final int arg2) {",
	...
	public static class SkillTest extends AbstractSarlTest {
		...
		public void overridingCapacitySkill() throws Exception {
			final String expectedC1 = multilineString(
					...
					"public interface C1 extends Capacity {",
					"  @DefaultValueSource",
					"  public abstract void myaction(@DefaultValue(\"C1#MYACTION_0\") final int arg0, @DefaultValue(\"C1#MYACTION_1\") final int arg1, final int... arg2);",
					"  ",
					"  /**",
					"   * Default value for the parameter arg0",
					"   */",
		...
		public void missedActionImplementation() throws Exception {
			final String expectedC1 = multilineString(
					...
					"public interface C1 extends Capacity {",
					"  @DefaultValueSource",
					"  public abstract void myaction1(@DefaultValue(\"C1#MYACTION1_0\") final int a);",
					"  ",
					"  /**",
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"4\")",
					"  public static final int $DEFAULT_VALUE$MYACTION1_0 = 4;",
					"  ",
					"  @DefaultValueUse(\"int\")",
					"  @SyntheticMember",
					"  public default void myaction1() {",
			...
			final String expectedC2 = multilineString(
					...
					"  @DefaultValueSource",
					"  public abstract void myaction2(@DefaultValue(\"C2#MYACTION2_0\") final float b, final boolean c);",
					"  ",
					"  /**",
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"6\")",
					"  public static final float $DEFAULT_VALUE$MYACTION2_0 = 6;",
					"  ",
					"  @DefaultValueUse(\"float,boolean\")",
					"  @SyntheticMember",
					"  public default void myaction2(final boolean c) {",
