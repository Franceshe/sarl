...
/** Provide static comparison operators for numbers of type {@code int}.
 *
...
public final class PrimitiveIntComparisonExtensions {
	...
	public static boolean operator_greaterEqualsThan(int left, Number right) {
	...
	@Pure
	@Inline(value = "($1 <= $2.doubleValue())", constantExpression = true)
	public static boolean operator_lessEqualsThan(int left, Number right) {
		return left <= right.doubleValue();
	}
	...
	@Pure
	@Inline(value = "($1 > $2.doubleValue())", constantExpression = true)
	public static boolean operator_greaterThan(int left, Number right) {
		return left > right.doubleValue();
	}
	...
	@Pure
	@Inline(value = "($1 < $2.doubleValue())", constantExpression = true)
	public static boolean operator_lessThan(int left, Number right) {
		return left < right.doubleValue();
	}
	...
	public static boolean operator_equals(int left, Number right) {
	...
	@Pure
	@Inline(value = "($2 == null || $1 != $2.doubleValue())", constantExpression = true)
	public static boolean operator_notEquals(int left, Number right) {
		return right == null || left != right.doubleValue();
	}
	...
	public static int operator_spaceship(int left, byte right) {
	...
	@Pure
	@Inline(value = "$3.compare($1, $2)", constantExpression = true, imported = Integer.class)
	public static int operator_spaceship(int left, short right) {
		return Integer.compare(left,  right);
	}
	...
	@Pure
	@Inline(value = "$3.compare($1, $2)", constantExpression = true, imported = Integer.class)
	public static int operator_spaceship(int left, int right) {
		return Integer.compare(left,  right);
	}
	...
	public static int operator_spaceship(int left, long right) {
	...
	public static int operator_spaceship(int left, float right) {
	...
	public static int operator_spaceship(int left, double right) {
	...
	public static int operator_spaceship(int left, Integer right) {
	...
	@Pure
	@Inline(value = "$3.compare($1, $2.intValue())", constantExpression = true, imported = Integer.class)
	public static int operator_spaceship(int left, AtomicInteger right) {
		return Integer.compare(left,  right.intValue());
	}
	...
	@Pure
	@Inline(value = "$3.compare($1, $2.longValue())", constantExpression = true, imported = Long.class)
	public static int operator_spaceship(int left, AtomicLong right) {
		return Long.compare(left,  right.longValue());
	}
	...
	@Pure
	@Inline(value = "$3.compare($1, $2.doubleValue())", constantExpression = true, imported = Double.class)
	public static int operator_spaceship(int left, Number right) {
		return Double.compare(left,  right.doubleValue());
	}
