...
public final class SARLVersion {
	 ...
	 */
	public static final String SPECIFICATION_RELEASE_VERSION_STRING = "0.11"; //$NON-NLS-1$
	 ...
	 */
	public static final String SARL_RELEASE_VERSION = "0.11.0"; //$NON-NLS-1$
	 ...
	 * @see #SARL_RELEASE_VERSION_MAVEN
	 */
	public static final String SARL_RELEASE_VERSION_OSGI = "0.11.0.qualifier"; //$NON-NLS-1$
	 ...
	 */
	public static final String MINIMAL_XTEXT_VERSION = "2.20.0"; //$NON-NLS-1$
